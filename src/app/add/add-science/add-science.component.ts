...
@Component({
  selector: 'app-add-science',
  templateUrl: './add-science.component.html',
  styleUrls: ['./add-science.component.css']
})
export class AddScienceComponent implements OnInit {
  ...
  addNewBook(){
    ...
    if(this.form.value.rating>0 && this.form.value.rating<=100)
    {
      ...
      if(this.form.value.PDF==='')this.form.value.PDF=null;
        ...
        this.book.science(this.form.value);
    }
    else{
