...
export class ScienceComponent implements OnInit {
  ...
  deletebook(){
    this.delete_edit.deletebook("science",this.bookid)
    .subscribe(()=>{
      this.booklist.science();
    })
  }
  ...
  updatebook(){
    this.delete_edit.updatebook("science",this.bookid,this.form.value)
    .subscribe((response)=>{
  ...
  //     // })
  // });
  this.booklist.science_search(this.search);
  }
