...
export class SelfhelpComponent implements OnInit {
  ...
  deletebook(){
    this.delete_edit.deletebook("selfhelp",this.bookid)
    .subscribe(()=>{
      this.booklist.selfhelp();
    })
  }
  ...
  updatebook(){
    this.delete_edit.updatebook("selfhelp",this.bookid,this.form.value)
    .subscribe((response)=>{
  ...
  //     // })
  // });
  this.booklist.selfhelp_search(this.search);
  }
