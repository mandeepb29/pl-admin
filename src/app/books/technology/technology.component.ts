...
export class TechnologyComponent implements OnInit {
  ...
  deletebook(){
    this.delete_edit.deletebook("technology",this.bookid)
    .subscribe(()=>{
      this.booklist.technology();
    })
  }
  ...
  updatebook(){
    this.delete_edit.updatebook("technology",this.bookid,this.form.value)
    .subscribe((response)=>{
  ...
  //     // })
  // });
  this.booklist.technology_search(this.search);
  }
